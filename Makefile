...
ex3.gen.wrap.json: ex3.gen.json
	cat ex3.gen.json | sed -e 's/,"n"/,#   "n"/' | tr "#" "\n" > ex3.gen.wrap.json

ex6.gen.wrap.json: ex6.gen.json
	cat ex6.gen.json | sed -e 's/,"u"/,#   "u"/' | tr "#" "\n" > ex6.gen.wrap.json
