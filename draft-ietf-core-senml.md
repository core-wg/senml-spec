...
system where a sensor sends a SenML record with a "now"-referenced time over a
...
satellite link from a mountain valley might have resulting time values that
are up to 15 minutes off the actual time of the sensor reading, with
